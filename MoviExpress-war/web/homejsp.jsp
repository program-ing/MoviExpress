<%-- 
    Document   : homejsp
    Created on : 17/03/2019, 12:36:22 AM
    Author     : juancuervo
--%>
    ...
    <body>
        <header class="header">
            <div class="contenedor logo-nav-container">
                <a href="#" class="logo">MOVIEXPRESS</a><!-- reemplazar por el logo -->
                <nav class="navegation">
                    <ul>
                        <li><a href="homejsp.jsp">Home</a></li>
                        <li><a href="#">Registrarse</a></li> <!-- reemplazar el # por la pagina de registro -->
                        <li><a href="#">Iniciar sesión</a></li> <!-- reemplazar el # por la inicio de sesion -->
                    </ul>
                </nav>  
            </div>
        </header>
        ...
        <main class="main">
            <div class="contenedor">
                <h1>BIENVENIDO A MOVIEXPRESS</h1>
